...
class ConsultaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultum" do
    assert_difference("Consultum.count") do
      post consulta_url, params: { consultum: { data_hora: @consultum.data_hora, dentistum_id: @consultum.dentistum_id, paciente_id: @consultum.paciente_id } }
    end
  ...
  test "should update consultum" do
    patch consultum_url(@consultum), params: { consultum: { data_hora: @consultum.data_hora, dentistum_id: @consultum.dentistum_id, paciente_id: @consultum.paciente_id } }
